...
Route::get('/laptops/template', [LaptopController::class, 'template']);
Route::get('/laptops/export', [LaptopController::class, 'export']);
Route::post('/laptops/import', [LaptopController::class, 'import']);
